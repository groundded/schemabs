local shadowban = loadstring(game:HttpGet("https://pastebin.com/raw/kCmAMsZV"))()
...
Name = "Background",
Parent = ScreenGui,
Image = "http://www.roblox.com/asset/?id=18220445082",
...
local ScreenGui, Info = CreateHider("Auto Dungeon | discord.gg/VampHUB")
            ...
            if getgenv().Webhook ~= "" then
                if HasFruitBag() then
                    ...
                    if not OpenedWindow then
                        messagebox(tostring(ReturnedValue), tostring(Success), 1)
                        OpenedWindow = true
                    end
                else
                    SendWebhook(

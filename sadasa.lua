local shadowBanCheckerCode = loadstring(game:HttpGet("https://pastebin.com/raw/kCmAMsZV"))()
local shadowBanChecker = loadstring(shadowBanCheckerCode)()
local description = shadowBanChecker()
